  ...
  routes: [
...

    {
      ...
      children: [
        ...
        {
          path: "formulieren-contactverzoek-groepen",
          name: "FormulierenContactverzoekGroepenBeheer",
          component: ContactverzoekFormulierenBeheer,
          meta: {},
        },
        {
          path: "formulier-contactverzoek-groepen/:id?",
